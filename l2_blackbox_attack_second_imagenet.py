...
#        loss3 = tf.reduce_sum(output)
    ...
    def attack_batch(self, imgs, labs):
     ...
     #       aa,bb,cc,dd = self.grad(imgs, labs, delt)
            loss, log_value , log_value_other, realpro  = self.grad3(imgs, labs, delt)
            ...
            for iii in range(Query_iterations):
                ...
                dir_normal = dirc / sss
                temploss, temp_log, temp_log_other,_ = self.grad3( imgs + u * dir_normal, labs, delt)
